...
INSERT INTO public.products (product_id, category, name, price, description, image_url, inventory) VALUES (1, 'iPhone','iPhone 14', 956.97, 'Swiss cheese is a mild cow''s milk cheese with a firmer texture than baby Swiss. The flavor is light, sweet, and nutty. Swiss cheese is distinguished by its luster, pale yellow color, and large holes (called eyes) caused by carbon dioxide released during the maturation process.', 'https://www.apple.com/newsroom/images/product/iphone/standard/Apple-iPhone-14-iPhone-14-Plus-2up-purple-220907_inline.jpg.large.jpg', 0);
INSERT INTO public.products (product_id, category, name, price, description, image_url, inventory) VALUES (2, 'iPhone','iPhone 14 pro', 759.19, 'Pears are rich in essential antioxidants, plant compounds, and dietary fiber. They pack all of these nutrients in a fat free, cholesterol free, 100 calorie package.', 'https://store.storeimages.cdn-apple.com/4982/as-images.apple.com/is/iphone-14-pro-model-unselect-gallery-2-202209_GEO_US?wid=5120&hei=2880&fmt=p-jpg&qlt=80&.v=1660753617560 ', 0);
INSERT INTO public.products (product_id, category, name, price, description, image_url, inventory) VALUES (3, 'Android','Google Pixel 7 pro', 979.29, 'A small, round, yeast-leavened sourdough bread that is commonly sliced horizontally, toasted, and buttered. In North America and Australia, it is commonly eaten for breakfast, often with sweet or savory toppings such as fruit jam or honey, or eggs, sausage, bacon, or cheese.', 'https://www.cnet.com/a/img/resize/8f3309175fdd17307e2d684455d0d30cdb699dd4/hub/2022/10/11/1976fdac-2da2-461a-bf0a-d1ddb8e3ef90/pixel-7-pro-watch-lanxon-promo-14.jpg?auto=webp&fit=crop&height=362&width=644', 0);
INSERT INTO public.products (product_id, category, name, price, description, image_url, inventory) VALUES (4, 'Android','Samsung galaxy s22 ultra', 669.45, 'Wasabi paste is spicy and pungent in flavour and is most commonly served with sushi and sashimi.', 'https://www.dpreview.com/files/p/articles/4617565053/samsung-galaxy-s22-ultra-lineup.jpeg ', 0);